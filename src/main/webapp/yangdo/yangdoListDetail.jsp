...
<body>
   <form name="yangdoListDetailForm" method="post" action="yangdoListDetail.do">
      ...
      <table border="1" width="500">
         <tr>
            ...
            <td align="center">
            	<input type="text" size="55" name="subject" value="${dto.res_start_date }">
            </td>
         </tr>
         <tr>
            ...
            <td align="center">
            	<textarea cols="55" rows="10" name="content" 
            		...
            		required>${dto.res_date_date }</textarea>
            </td>
         </tr>
         <tr>
