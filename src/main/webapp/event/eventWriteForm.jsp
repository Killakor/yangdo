	...
	<div id="wrap">
		...
		<div class="container">
			...
			<div id="content">
				...
				<div class="tab_each">
					<form action="eventWrite.do" id="eventWriteForm" method="post" 
									name="eventWriteForm" enctype="multipart/form-data">
									
						<div id="event_title">
							<strong>이벤트 제목</strong>
							<input type="text" class="noButton1" name="event_subject">
							<label id="subject_msg_label" class="msg_label" style="color: red;"></label>
						</div>
						
						<div id="event_period">
							<strong>이벤트 기간</strong>
							시작 : <input type="date" class="noButton3" name="event_start">
							종료 : <input type="date" class="noButton3" name="event_end">
						</div>
						<label id="period_msg_label" class="msg_label" style="color: red;"></label>
						
						<div id="event_cont">
							<strong>이벤트 내용</strong>
							<textarea name="event_content" class="noButton2" rows="15" cols="45"></textarea>
							<label id="cont_msg_label" class="msg_label" style="color: red;"></label>
						</div>
						
						<div id="event_file">
							<strong>이벤트 이미지</strong>
							<input type="file" name="event_image" accept="image/jpeg, image/png">
						</div>
						<label id="img_msg_label" class="msg_label" style="color: red;"></label>
						
						<div class="btn_wrap">
							<input type="button" class="noButton4" value="목록보기" onclick="location.href='eventList.do'">
